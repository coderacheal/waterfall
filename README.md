...
# Waterfall <a name="about-project"></a>

**Waterfall** is a product management tool
...
- **Add a task**
- **Assign a task**
- **Delete and add a due date and priority**
...
```sh
  cd my-folder
  git clone https://github.com/coderacheal/waterfall.git
```
